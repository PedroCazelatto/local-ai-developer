...
- **Throwaway-context model** — which LLM (and which context size) powers `search_rules` and
  summarization: the same local model, or a smaller/faster one. See [rules-loading.md](rules-loading.md).
