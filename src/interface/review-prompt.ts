...
// printing: the accept/send-back/skip decision is collected by the REPL over readline (repl.ts), to
...
function tokenLine(tokens: TokenCounts): string {
