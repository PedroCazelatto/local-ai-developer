...
// persistence, CLAUDE.md), never in the orchestrator repo, and is NEVER injected into any phase's
// prompt: it is append-only, a replay/audit artifact exactly like the audit log.
//
