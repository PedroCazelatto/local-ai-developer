// The activity line's state, in a module of its own because one function per file put the functions
// that read and write it into five separate files, and an ESM binding cannot be reassigned across a
...
//   - only activity-line.ts's own functions may write it;
//   - nothing outside that family may import this file at all — callers go through the activityLine
